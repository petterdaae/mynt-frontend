...
const StyledFaHome = styled(FaHome)`
  ${iconStyle}
`;
const StyledFaWallet = styled(FaWallet)`
  ${iconStyle}
`;
const StyledFaShapes = styled(FaShapes)`
  ${iconStyle}
`;
  ...
  return (
    <Wrapper>
      <Navigation>
        ...
        <NavigationItem path="/authenticated/dashboard">
          <StyledFaHome /> Dashboard
        </NavigationItem>
        <NavigationItem path="/authenticated/spendings">
          <StyledFaWallet /> Spendings
        </NavigationItem>
        <NavigationItem path="/authenticated/categories">
          <StyledFaShapes /> Categories
        </NavigationItem>
        <NavigationItem path="/authenticated/settings">
          <StyledFaCog /> Settings
        </NavigationItem>
      </Navigation>
